#define NGX_CONFIGURE " --with-http_v2_module --with-http_realip_module --with-http_gunzip_module --with-http_gzip_static_module --add-module=modules/ngx_http_concat_module/"
...
#ifndef T_NGX_HTTP2_SRV_ENABLE
#define T_NGX_HTTP2_SRV_ENABLE  1
#endif
